...
const dict = {
  en: {
    ...
    stageBoe: "5 BoE",
    independentHeadline: "You first. The draft stays closed until you enter your own range.",
    independentBody:
    ...
    workspaceSubtitle: "Every estimate in flight — stage, open questions, and who is waiting.",
    ...
    keyboardHint: "An estimate opens on its Reading Room; the desk stays closed until you enter your own range.",
    ...
    composerHint: "Tick the questions to send; the letter below is what the customer receives.",
    ...
    openDesk: "Open desk",
    deskClosedHint: "Enter your name and open the desk — the draft stays closed until you record your own range.",
    likelyShort: "likely",
    range: "Range",
    ...
    ledgerSubtitle: "What similar work actually cost, and how far the estimate was off.",
    entriesWord: "entries",
    withActuals: "with actuals",
    analogSearchPlaceholder: "Search analogs — e.g. taksitli fatura",
    search: "Search",
    clearSearch: "Clear",
    analogRankHint: "Ranked by the same retrieval the estimator reads — outcome feedback included.",
    ledgerEmpty: "The ledger is empty — import the seed set or record actuals.",
    modules: "Modules",
    estimateGiven: "Estimate given",
    source: "Source",
    ledgerFootnote: "Scope-changed rows are kept for honesty but excluded from calibration.",
    calibrationSubtitle: "Are our ranges honest? The product grades itself.",
    howHonest: "Interval honesty",
    completedItems: "completed items",
    coverageVsTarget: "We captured actuals inside the range {actual} of the time against a target of {target}.",
    ...
    anchoringSubtitle: "Independent bands should rarely match the draft; rework should not grow while drafting speeds up.",
    nominalWord: "nominal",
    naiveMedian: "naive (median)",
    knowledgeSubtitle: "Candidate pages reviewed against their sources, then published with a version.",
    queueWord: "Queue",
    driftedWord: "Drifted",
    ...
    versionFootnote: "Publishing is versioned. Every estimate cites the page version it actually read.",
    ...
    firstSyncHint: "Indexing — a large wiki can take days. You can keep working while it runs.",
    rolesFootnote: "Roles come from your identity provider's token claim; Estimo never stores a user list.",
  ...
  tr: {
    ...
    stageBoe: "5 BoE",
    independentHeadline: "Önce siz. Kendi aralığınızı girene kadar taslak kapalı kalır.",
    independentBody:
    ...
    workspaceSubtitle: "Devam eden tüm estimeler — aşama, açık sorular ve kimin beklendiği.",
    ...
    openQ: "Açık soru",
    waitingOn: "Beklenen",
    keyboardHint: "Estime, Okuma Odası'nda açılır; kendi aralığınızı girene kadar masa kapalı kalır.",
    ...
    composerHint: "Gönderilecek soruları işaretleyin; aşağıdaki mektup müşteriye gidecek olandır.",
    openPoints: "Açık maddeler",
    selectToCompose: "Mektubu oluşturmak için bir soru işaretleyin.",
    copyText: "Metni kopyala",
    impactShort: "Etki",
    impactSubtitle: "Bu BRD'nin hangi modüllere dokunduğu, iş kalemi sayısıyla.",
    openDesk: "Masayı aç",
    deskClosedHint: "Adınızı girip masayı açın — kendi aralığınızı kaydedene kadar taslak kapalı kalır.",
    likelyShort: "olası",
    range: "Aralık",
    ...
    ledgerSubtitle: "Benzer işlerin gerçekte ne tuttuğu ve tahminin ne kadar saptığı.",
    entriesWord: "kayıt",
    withActuals: "gerçekleşmeli",
    analogSearchPlaceholder: "Analog ara — ör. taksitli fatura",
    search: "Ara",
    clearSearch: "Temizle",
    analogRankHint: "Tahmincinin okuduğu aramayla aynı sıralama — sonuç geri beslemesi dahil.",
    ledgerEmpty: "Defter boş — seed set'i içe aktarın veya gerçekleşme kaydedin.",
    modules: "Modüller",
    estimateGiven: "Verilen tahmin",
    source: "Kaynak",
    ledgerFootnote: "Kapsamı değişen satırlar dürüstlük için tutulur, kalibrasyondan çıkarılır.",
    ...
    coverageVsTarget: "Gerçekleşmeleri aralığın içinde {actual} oranında yakaladık; hedef {target}.",
    ...
    anchoringSubtitle: "Bağımsız bantlar taslakla nadiren örtüşmeli; taslak hızlanırken yeniden iş artmamalı.",
    nominalWord: "nominal",
    naiveMedian: "naif (medyan)",
    knowledgeSubtitle: "Aday sayfalar kaynaklarına karşı incelenir, sonra sürümlenerek yayımlanır.",
    queueWord: "Kuyruk",
    driftedWord: "Sapmış",
    ...
    versionFootnote: "Yayım sürümlüdür. Her estime, okuduğu sayfa sürümünü referans verir.",
    selectCandidate: "Kaynaklarına karşı incelemek için bir aday seçin.",
    adminSubtitle: "Sıkıcı ama şeffaf: senkron durumu, hata kuyrukları, roller.",
    ...
    maySignFull: "tüm BoE",
    firstSyncHint: "İndeksleniyor — büyük bir wiki günler sürebilir. Bu sürerken çalışmaya devam edebilirsiniz.",
    rolesFootnote: "Roller kimlik sağlayıcınızın token claim'inden gelir; Estimo kullanıcı listesi tutmaz.",
