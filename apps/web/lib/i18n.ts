...
const dict = {
  ...
  tr: {
    ...
    teamWord: "Ekip",
    domainWord: "Alan",
    cadenceLabel: "Senkron aralığı (dk)",
    cadenceOff: "elle",
    pinPlaceholder: "Sayfa ID / iş anahtarı",
    pinNow: "Sabitle",
    allDisciplines: "Tüm disiplinler",
    disciplineWord: "Disiplin",
    frontendWord: "Ön yüz",
    backendWord: "Arka uç",
    disciplineSplit: "Disiplin dağılımı",
    modelProposedBadge: "model önerisi — kalibre edilmemiş",
    historicalRatioBadge: "tarihsel oran",
