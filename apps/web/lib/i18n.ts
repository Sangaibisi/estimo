...
const dict = {
  en: {
    ...
    gatewayHint:
      "Every model call flows through this one OpenAI-compatible endpoint — LiteLLM in production. Configured via ESTIMO_GATEWAY__* env vars; changes take a restart.",
    stageHeader: "Stage",
    ...
    envOnlyHint:
      "Configuration is environment-only by design: this panel reports, it never edits. To change anything, change the env var and restart the API.",
  },
  tr: {
    appTitle: "Estimo",
    ...
    gatewaySection: "Model gateway",
    gatewayHint:
      "Tüm model çağrıları bu tek OpenAI-uyumlu uçtan geçer — üretimde LiteLLM. ESTIMO_GATEWAY__* env değişkenleriyle yapılandırılır; değişiklik yeniden başlatma ister.",
    stageHeader: "Aşama",
    ...
    envOnlyHint:
      "Yapılandırma tasarım gereği yalnız environment'tan gelir: bu panel gösterir, asla düzenlemez. Değiştirmek için env değişkenini değiştirip API'yi yeniden başlatın.",
  },
} as const;
